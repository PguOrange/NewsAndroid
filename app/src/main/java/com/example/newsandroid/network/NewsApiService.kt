...
interface NewsApiService {
    ...
    @GET("everything")
    fun getEverything(@Query("q") q : String, @Query("page") page: Int, @Query("language") language : String?, @Query("sortBy") sortBy : String, @Query("from") from : String?, @Query("to") to : String?, @Query("apiKey") apiKey : String = BuildConfig.ApiKey):
            Deferred<NewsCollection>
