...
import com.example.newsandroid.network.RetrofitClientInstance
...
private val newsApiService : NewsApiService = RetrofitClientInstance().getInstance().create(NewsApiService::class.java)
